...
- A página principal usa `/`; acessos legados a `/index.html` ou `/index.html/` são redirecionados permanentemente, preservando as âncoras das seções e com normalização adicional no navegador.
